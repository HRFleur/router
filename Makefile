...
CFLAGS = -g -Wall -ansi -D_DEBUG_ -D_GNU_SOURCE $(ARCH)  -std=c99
...
sr_HDRS = sr_arpcache.h sr_utils.h sr_dumper.h sr_if.h sr_protocol.h sr_router.h sr_rt.h  \
          vnscommand.h sha1.h sr_arp.h sr_icmp.h sr_ip.h sr_nat.h sr_nat_icmp.h sr_nat_tcp.h

# Add any source files you've added here
sr_SRCS = sr_router.c sr_main.c sr_if.c sr_rt.c sr_vns_comm.c sr_utils.c sr_dumper.c  \
          sr_arpcache.c sha1.c sr_icmp.c sr_arp.c sr_ip.c sr_nat.c sr_nat_icmp.c sr_nat_tcp.c
